...
const ALCHEMY_API_KEY =
  process.env.NEXT_PUBLIC_ALCHEMY_API_KEY || "your-alchemy-key";
...
if (hasValidProjectId) {
  ...
  const metadata = {
    ...
    url:
      typeof window !== "undefined"
        ...
        : "https://Tip Flow.app",
    icons: ["https://Tip Flow.app/Tip Flow.png"],
  };
  ...
  console.warn(
    "⚠️ Reown Project ID not configured. Using fallback wagmi configuration."
  );
