...
2. **Fill in your app details**:
   ...
   ```
   Domain: Tip Flow.vercel.app (or your custom domain)
   App Name: Tip Flow
   Description: Tip your audience for engagement on Farcaster
   Category: social
   Tags: tipping, rewards, engagement, farcaster

   Icon URL: https://Tip Flow.vercel.app/icon.png
   Home URL: https://Tip Flow.vercel.app
   Splash Image: https://Tip Flow.vercel.app/splash.png
...
```json
{
  "miniapp": {
    "version": "1",
    "name": "Tip Flow",
    "iconUrl": "https://Tip Flow.vercel.app/icon.png",
    "homeUrl": "https://Tip Flow.vercel.app",
    "imageUrl": "https://Tip Flow.vercel.app/og-image.png",
    "buttonTitle": "💰 Start Tipping",
    "splashImageUrl": "https://Tip Flow.vercel.app/splash.png",
...
1. **Choose your domain**: Use `Tip Flow.vercel.app` (your current Vercel deployment)
2. **Verify ownership**: The manifest will be automatically verified when you deploy
3. **Test the manifest**: Visit `https://Tip Flow.vercel.app/.well-known/farcaster.json`
...
2. **Test the manifest**:
   ...
   - Visit: `https://Tip Flow.vercel.app/.well-known/farcaster.json`
...
3. **Submit to Farcaster**:
   ...
   - Users can find it by searching for "Tip Flow" or "tipping"
