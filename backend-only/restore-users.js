...
const deletedFids = [
  249432, 15086, 250869, 564447, 1052964, 200375, 849116, 1161826, 520364,
  1351395, 1007471, 1104000, 507756, 243108, 306502, 963470, 230238, 472963,
  240486, 441699, 476026, 242597, 4163,
];
...
async function restoreUsers() {
  ...
  try {
    ...
    updateResult.rows.forEach((user) => {
      console.log(
        `   - FID ${user.fid}: ${user.username || "N/A"} (${
