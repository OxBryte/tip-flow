# Farcaster Mini App Manifest Data for Tip Flow
...
- **Description**: `With Tip Flow you can boost your casts by tipping engagers for their interactions easily.`
...
- **Screenshots**:
  ```
  https://Tip Flow.vercel.app/screenshot1.png
  https://Tip Flow.vercel.app/screenshot2.png
  https://Tip Flow.vercel.app/screenshot3.png
  ```
- **Preview Image**: `https://Tip Flow.vercel.app/image.png`
- **Hero Image**: `https://Tip Flow.vercel.app/hero.png`
- **Splash Screen Image**: `https://Tip Flow.vercel.app/splash.png`
- **Splash Background Color**: `#fef3c7` (yellow theme to match your app)

### Engagement & Discovery

- **Search Tags**: `tip, tipping, noice, Tip Flow, engage`
- **Marketing Tagline**: `Boost your casts with Tip Flow`
- **Button Title**: `Start Tipping`
- **Social Share Title**: `Tip Flow – Tip Your Audience`
- **Social Share Description**: `With Tip Flow you can boost your casts by tipping engagers for their interactions easily.`
- **Social Share Image**: `https://Tip Flow.vercel.app/og-image.png`
- **Cast Share URL**: `https://warpcast.com/~/compose?text=Check+out+Tip Flow+-+tip+your+audience+for+engagement%21`

### Technical Configuration

- **Home URL**: `https://Tip Flow.vercel.app`
- **Webhook URL**: `https://Tip Flow-backend-production.up.railway.app/api/webhook`
...
- **Content**: Tip Flow logo with "Tip Your Audience" tagline
...
- **Text**: "Tip Flow - Tip Your Audience"
