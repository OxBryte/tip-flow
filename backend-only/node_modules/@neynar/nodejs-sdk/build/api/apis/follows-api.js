...
exports.FetchUserReciprocalFollowersSortTypeEnum = exports.FetchUserFollowingSortTypeEnum = exports.FetchUserFollowersSortTypeEnum = exports.FollowsApi = exports.FollowsApiFactory = exports.FollowsApiFp = exports.FollowsApiAxiosParamCreator = void 0;
...
const FollowsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         *
         */
        fetchUserReciprocalFollowers: async (fid, xNeynarExperimental, viewerFid, limit, cursor, sortType, options = {}) => {
            // verify required parameter 'fid' is not null or undefined
            (0, common_1.assertParamExists)('fetchUserReciprocalFollowers', 'fid', fid);
...
const FollowsApiFp = function (configuration) {
    ...
    return {
         ...
         *
         */
        async fetchUserReciprocalFollowers(fid, xNeynarExperimental, viewerFid, limit, cursor, sortType, options) {
            var _a, _b, _c;
            ...
            const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
            const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['FollowsApi.fetchUserReciprocalFollowers']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
            return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    };
};
...
const FollowsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         *
         */
        fetchUserReciprocalFollowers(requestParameters, options) {
...
class FollowsApi extends base_1.BaseAPI {
     ...
     */
    fetchUserReciprocalFollowers(requestParameters, options) {
        return (0, exports.FollowsApiFp)(this.configuration).fetchUserReciprocalFollowers(requestParameters.fid, requestParameters.xNeynarExperimental, requestParameters.viewerFid, requestParameters.limit, requestParameters.cursor, requestParameters.sortType, options).then((request) => request(this.axios, this.basePath));
    }
}
 ...
 * @export
 */
exports.FetchUserReciprocalFollowersSortTypeEnum = {
    DescChron: 'desc_chron',
    Algorithmic: 'algorithmic'
};
