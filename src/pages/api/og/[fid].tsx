...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  try {
    ...
    const backendUrl =
      ...
      "https://tippit-production.up.railway.app";
    ...
    const avatarImage = userProfile.pfpUrl
      ? `<image href="${userProfile.pfpUrl.replace(
          /"/g,
          "&quot;"
...
<svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- User name -->
  <text x="400" y="280" font-family="Arial, sans-serif" font-size="56" font-weight="bold" fill="#F8FAFC">${displayName}</text>
  <text x="400" y="330" font-family="Arial, sans-serif" font-size="36" fill="#94A3B8">@${username}</text>
